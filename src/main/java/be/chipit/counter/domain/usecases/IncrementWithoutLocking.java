...
@Slf4j
public class IncrementWithoutLocking {

    private final CounterByNamePort counterByNamePort;
    private final SaveCounterPort saveCounterPort;

    /**
     * In this use case we use a transaction with isolation level SERIALIZABLE.
     *
    ...
    public Counter increment(String name, long delayInSeconds) {
        Counter counter = counterByNamePort.getByName(name, false)
